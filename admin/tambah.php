        ...
        <form action="" method="post" enctype="multipart/form-data" class="w-50 mx-auto">
          ...
          <div class="mb-3">
            ...
            <select name="stok" id="stok" class="form-control">
              <option value="">masukan stok</option>
                ...
                if ($name_file != "") {
                    if ($file_size > 500000) {
                        ...
                        if ($file_type != "jpg" && $file_type != 'png' && $file_type != "jpeg") {
                            ...
                            $tambahBuku = mysqli_query($koneksi, "INSERT INTO buku (judul, penulis, tahun, stok, gambar, deskripsi) VALUES ('$judul', '$penulis', '$tahun', '$stok', '$new_name', '$deskripsi')");

                            if ($tambahBuku) {
                                echo "<script>alert('Buku ditambahkan!!!')</script>";
                            } else {
